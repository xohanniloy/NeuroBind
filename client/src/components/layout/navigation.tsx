      ...
      <div className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/blog" className={`relative group hover:text-electric-blue transition-all duration-300 transform hover:scale-105 ${
              isActive("/blog") ? "text-electric-blue" : ""
            }`}>
              <span className="relative z-10">Blog</span>
              <span className={`absolute inset-0 bg-gradient-to-r from-electric-blue/20 to-neuro-purple/20 rounded-full transition-all duration-300 ${
                isActive("/blog") ? "w-full px-3 py-1" : "w-0 group-hover:w-full group-hover:px-3 group-hover:py-1"
              }`}></span>
            </Link>
            <Link href="/website-trust-guide" className={`relative group hover:text-neon-green transition-all duration-300 transform hover:scale-105 ${
              isActive("/website-trust-guide") ? "text-neon-green" : ""
            }`}>
              <span className="relative z-10">Trust Guide</span>
              <span className={`absolute inset-0 bg-gradient-to-r from-neon-green/20 to-electric-blue/20 rounded-full transition-all duration-300 ${
                isActive("/website-trust-guide") ? "w-full px-3 py-1" : "w-0 group-hover:w-full group-hover:px-3 group-hover:py-1"
              }`}></span>
            </Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 glassmorphism-dark rounded-2xl p-6 animate-slide-down">
            <div className="flex flex-col space-y-4">
              ...
              <Link 
                href="/website-trust-guide"
                onClick={() => setIsMobileMenuOpen(false)}
                className={`text-left hover:text-neon-green transition-all duration-300 p-2 rounded-lg hover:bg-gradient-to-r hover:from-neon-green/10 hover:to-electric-blue/10 transform hover:translate-x-2 ${
                  isActive("/website-trust-guide") ? "text-neon-green" : ""
                }`}
              >
                Trust Guide
