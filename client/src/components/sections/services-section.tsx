...
export default function ServicesSection(): React.JSX.Element {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "আজকের দিনে সবচেয়ে দামি জিনিস হলো মানুষের Attention। আমরা এমন কনটেন্ট তৈরি করি যেটা Scroll-Stopper Text, Emotion-driven Script, Attention-grabbing Image, আর Engaging Video Content।",
      features: [
      ...
      advanced: [
        "📰 Text, Script, Image, Video Content",
        "⚡ Pattern Breaker কৌশল",
        "💭 Emotional trigger + Logic balance",
        "✅ A/B Testing করা hook"
      ],
      stats: { success: "৫০০০+", metric: "প্রতিদিন Content দেখে" }
    },
    {
      slug: 'lead-magnet',
      icon: Magnet,
